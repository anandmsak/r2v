...
export const archiveElection     = (id) => axiosClient.post(`/elections/${id}/archive`);
export const getCandidates       = (electionId) => axiosClient.get(`/candidates/${electionId}`);
export const addCandidate        = (data) => axiosClient.post("/candidates/", data);
export const getResults          = (electionId) => axiosClient.get(`/results/${electionId}`);
