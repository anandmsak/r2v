...
export default function BallotPage() {
  ...
  if (step === "loading")
    return (
      <FullPage>
        <LoadingSpinner text="Securing ballot token…" />
      </FullPage>
    );
  if (step === "casting")
    return (
      <FullPage>
        <LoadingSpinner text="Recording vote in chain…" />
      </FullPage>
    );
  if (step === "error")
    return (
      ...
      <div style={s.container}>
        ...
        {step === "select" && (
          <>
            <p style={s.instruction}>
              Select one candidate. This action is permanent.
            </p>
            <div style={s.list}>
              {candidates.map((c) => (
                <div
            ...
            <button
              style={{ ...s.castBtn, ...(selected ? {} : s.disabled) }}
              disabled={!selected}
        ...
        {step === "confirm" && (
          <div style={s.confirmBox}>
            ...
            <div style={s.warning}>
              ⚠ Your vote is anonymous and permanent. Once cast, it cannot be
              changed.
            </div>
            <div style={s.confirmBtns}>
              <button style={s.changeBtn} onClick={() => setStep("select")}>
                Change
              </button>
              <button style={s.castBtn} onClick={cast}>
                Confirm & Cast Vote →
              </button>
            </div>
          </div>
