...
export default function StudentLoginPage() {
  ...
  async function submit(e) {
    ...
    try {
      ...
      if (msg.includes("no account found") || msg.includes("not found") || err.message.includes("404")) {
        setError("No account found for this register number. Contact your election admin.");
    ...
    <div style={s.root}>
      ...
      <div style={s.card}>
        ...
        <form onSubmit={submit} style={s.form}>
          ...
          <button style={s.btn} type="submit" disabled={loading || !regNum.trim()}>
...
const s = {
  ...
  card: { background: "#111", border: "1px solid #1e1e1e", borderRadius: "16px", padding: "40px 48px", width: "100%", maxWidth: "420px", position: "relative", zIndex: 1 },
  ...
  portalBadge: { fontSize: "0.58rem", color: "#4ade80", border: "1px solid #1a3a1a", background: "#0a1a0a", borderRadius: "4px", padding: "2px 8px", letterSpacing: "0.1em" },
  title: { fontSize: "1.4rem", fontWeight: "700", color: "#fff", margin: "0 0 6px" },
  ...
  input: { background: "#0a0a0a", border: "1px solid #2a2a2a", borderRadius: "8px", color: "#fff", padding: "14px 16px", fontSize: "0.9rem", fontFamily: "inherit", outline: "none" },
